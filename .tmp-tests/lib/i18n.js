...
exports.formatLocaleDate = formatLocaleDate;
exports.formatLocaleDateTime = formatLocaleDateTime;
exports.formatLocaleNumber = formatLocaleNumber;
exports.formatLocalePrice = formatLocalePrice;
exports.localizeField = localizeField;
exports.localizeRecordField = localizeRecordField;
...
function localizeRecordField(record, field, locale, fallback = "") {
    if (!record) {
        return fallback;
    }
...
exports.siteCopy = {
    ar: {
        ...
        heroBody: "Moroccan Trip تجمع بين اكتشاف الوكالات والرحلات المنظمة وشركاء السفر في منصة محلية واحدة مع تواصل مباشر وحجز عملي.",
    ...
    fr: {
        ...
        heroBody: "Moroccan Trip rassemble agences, voyages organises et partenaires de voyage dans une meme plateforme locale avec contact direct et reservation simple.",

...
export function ListingCard({ listing, locale = "ar" }: ListingCardProps) {
  ...
  return (
    <Link
      ...
      className="group flex min-h-[420px] flex-col overflow-hidden rounded-[1.75rem] border border-slate-100 bg-white shadow-[0_16px_40px_rgba(15,61,46,0.08)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_rgba(15,61,46,0.16)]"
    >

  ...
  if (!session?.user?.id) {
    return (
      <WorkspaceAccessState
        ...
        body={locale === "ar" ? "سجل الدخول باش تشوف الحجوزات ديالك." : "Connectez-vous pour voir vos reservations."}
        primaryHref="/login"
  ...
  if (!dashboard.profile?._id) {
    return (
      <WorkspaceAccessState
        ...
        body={locale === "ar" ? "قبل ما تدير الحجوزات، خاصك تكمل ملف الوكالة ديالك." : "Avant de gerer les reservations, vous devez completer votre profil agence."}

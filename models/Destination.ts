...
const LocalizedStringSchema = new Schema({ ar: { type: String, default: "" }, fr: { type: String, default: "" }, en: { type: String, default: "" } }, { _id: false });
...
const SocialSchema = new Schema({ instagram: String, facebook: String, tiktok: String, youtube: String, website: String, other: String }, { _id: false });
...
const DestinationSchema = new Schema({
  ...
  gallery: [{ url: { type: String, required: true }, publicId: String, caption: { type: LocalizedStringSchema, default: () => ({}) } }],
